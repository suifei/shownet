...
Current release: [v0.4.31](https://github.com/suifei/shownet/releases/tag/v0.4.31). For a finer map of what is in and out of scope, see the [feature overview](docs/feature-map.md) (Chinese).
...
- WebSocket still uses rustls plus HTTP/1.1 Upgrade (wreq cannot terminate Upgrade). Frames can be stored. The outbound identity is not the same as HTTPS.
