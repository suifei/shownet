...
export const E2E_FEATURE_PILLARS: FeaturePillarCoverage[] = [
  ...
  },
  {
    ...
    artifacts: [
      ...
      "src-tauri/testdata/tls-golden/fingerprint-reference/detector-sites.json",
      "scripts/tls-golden-capture.mjs",
      "scripts/tls-detector-validate.mjs",
      "tests/tls-golden-gate.test.ts",
      "tests/tls-detector-validate.test.ts",
      "tests/advanced-console-capabilities.test.ts",
    ],
    shippedMarker: /ClientHello|chrome150|ja3Parity|browserParity|fidelityLabel|tls-golden-probe|measure-rustls|pending-capture|detector-sites|claimBrowserHundredPercent/,
  },
  {
