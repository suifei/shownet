...
function emptyDraft(sessionId?: string): RequestDraft { return { id: crypto.randomUUID(), sessionId: sessionId?.trim() || undefined, name: "新请求", method: "GET", url: "https://example.com/", headers: [], body: "", bodyType: "none", auth: { kind: "none" }, settings: { followRedirects: true, verifyTls: true, cookieJar: false }, tags: [], createdAt: Date.now(), updatedAt: Date.now() }; }
